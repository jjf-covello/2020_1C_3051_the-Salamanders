            ...
            public void RenderUpdateSpotLight()
            {
                ...
                foreach (var mesh in scene.Meshes)
                {
                    if (lightEnable)
                    {
                        ...
                        mesh.Effect.SetValue("lightPosition", TGCVector3.Vector3ToVector4(Camara.Position));
                        mesh.Effect.SetValue("eyePosition", TGCVector3.Vector3ToVector4(Camara.Position));
                        mesh.Effect.SetValue("spotLightDir", TGCVector3.Vector3ToVector4(lightDir));
